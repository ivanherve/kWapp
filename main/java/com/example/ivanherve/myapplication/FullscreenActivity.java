...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_Graphique).setOnTouchListener(mDelayHideTouchListener);
    }
...
//-------------------------------------------------------------------------------------------
    ...
    /**
     * Cette méthode est faite pour les 4 bouttons
     * @author Ivan HERVE
     */
    ...
    public void onClickGraphique (View view){
